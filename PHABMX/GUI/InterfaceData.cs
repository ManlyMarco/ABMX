...
namespace KKABMX.GUI
{
    ...
    public static class InterfaceData
    {
        ...
        public static MakerCategory FingerCategory => MakerConstants.Body.Arm;
        ...
        static InterfaceData()
        {
            ...
            {
                new BoneMeta("cf_J_FaceBase"        , "Head"              , 0   , 2f  , MakerConstants.Face.General      , "")                    {L = true          , LMax = 5f  , LDisplayName = "Head Position"}    ,
                new BoneMeta("cf_J_Head_s"          , "Head + Neck"       , 0   , 2f  , MakerConstants.Face.General      , "")                                       ,
                ...
                new BoneMeta("cf_J_FaceUp_ty"       , "Upper Head"        , 0   , 2f  , MakerConstants.Face.General      , "")                                       ,
                new BoneMeta("cf_J_FaceUp_tz"       , "Upper Front Head"  , 0   , 2f  , MakerConstants.Face.General      , "")                                       ,
                ...
                new BoneMeta("cf_J_FaceLow_s"       , "Lower Head + Cheek", 0   , 2f  , MakerConstants.Face.General  , "")                                       ,
                ...
                new BoneMeta("cf_J_Eye_s_L"         , "Eye"               , 0   , 1.5f, MakerConstants.Face.Eye     , "cf_J_Eye_s_R")                           ,

                new BoneMeta("cf_J_Eye01_s_L"       , "Inner Eyelashes"   , 0   , 3f  , MakerConstants.Face.Eyelash, "cf_J_Eye01_s_R")                         ,
                new BoneMeta("cf_J_Eye02_s_L"       , "Upper Eyelashes"   , 0   , 3f  , MakerConstants.Face.Eyelash, "cf_J_Eye02_s_R")                         ,
                new BoneMeta("cf_J_Eye03_s_L"       , "Outer Eyelashes"   , 0   , 3f  , MakerConstants.Face.Eyelash, "cf_J_Eye03_s_R")                         ,
                new BoneMeta("cf_J_Eye04_s_L"       , "Lower Eyelashes"   , 0   , 3f  , MakerConstants.Face.Eyelash, "cf_J_Eye04_s_R")                         ,
                ...
                new BoneMeta("cf_N_height"          , "Body"              , 0.5f, 1.5f, MakerConstants.Body.General      , "")                                       ,

                new BoneMeta("cf_J_Mune00_s_L"      , "Breast Scale 1"    , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune00_s_R")     {XYZPostfix = null},
                new BoneMeta("cf_J_Mune01_s_L"      , "Breast Scale 2"    , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune01_s_R")     {XYZPostfix = null},
                new BoneMeta("cf_J_Mune02_s_L"      , "Breast Scale 3"    , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune02_s_R")     {XYZPostfix = null},
                new BoneMeta("cf_J_Mune03_s_L"      , "Breast Tip"        , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune03_s_R")                        ,
                new BoneMeta("cf_J_Mune04_s_L"      , "Areola"            , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune04_s_R")     {L = true          , LMax = 4f  , LDisplayName = "Areola Protrusion"},
                new BoneMeta("cf_J_Mune_Nip01_s_L"  , "Nipple"            , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune_Nip01_s_R")                    ,
                new BoneMeta("cf_J_Mune_Nip02_s_L"  , "Nipple Tip"        , 0   , 3f  , MakerConstants.Body.Bust   , "cf_J_Mune_Nip02_s_R")                    ,
                new BoneMeta("cf_hit_Mune02_s_L"    , "Breast Collision"  , 0   , 3f  , MakerConstants.Body.Bust   , "cf_hit_Mune02_s_R")                      ,
                ...
                new BoneMeta("cf_J_ArmUp01_s_L"     , "Upper Arm Deltoids", 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmUp01_s_R")    {X = false}        ,
                new BoneMeta("cf_J_ArmUp02_s_L"     , "Upper Arm Triceps" , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmUp02_s_R")    {X = false}        ,
                new BoneMeta("cf_J_ArmUp03_s_L"     , "Upper Arm Lower"   , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmUp03_s_R")    {X = false}        ,
                new BoneMeta("cf_J_ArmElboura_s_L"  , "Elbow"             , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmElboura_s_R") {X = false}        ,
                new BoneMeta("cf_J_ArmElbo_low_s_L" , "Elbow Cap"         , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmElbo_low_s_R")        ,

                new BoneMeta("cf_J_ArmLow01_s_L"    , "Forearm Upper"     , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmLow01_s_R")   {X = false}        ,
                new BoneMeta("cf_J_ArmLow02_s_L"    , "Forearm Lower"     , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_ArmLow02_s_R")   {X = false}        ,

                new BoneMeta("cf_J_Hand_Wrist_s_L"  , "Wrist"             , 0   , 3f  , MakerConstants.Body.Arm      , "cf_J_Hand_Wrist_s_R") {X = false}        ,
                ...
                new BoneMeta("cf_J_Kokan"           , "Genital Area"      , 0   , 3f  , MakerConstants.Body.UnderHair    , "")                                       ,
                ...
                new BoneMeta("cf_J_Ana"             , "Anus"              , 0   , 3f  , MakerConstants.Body.UnderHair    , "")                                       ,
            };
        }
    }
}